...
Public Class Form4
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            If drd.Read() Then
                ...
                Me.TextBox6.Text = drd.Item("Cantidad").ToString
            Else
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If (TextBox5.Text = "" Or TextBox1.Text = "" Or TextBox7.Text = "") Then
        ...
        Else
            ...
            mensaje = "Registro de Entrada Completado"

            EjecutarSQL(sentencia, mensaje)
            ''Agrega datos a la tabla
            sentencia = " insert into Entradas values ('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox5.Text + "','" + DateTimePicker1.Text + "', '" + Label1.Text + "','" + TextBox7.Text + "')"
            mensaje = "Registro de Entrada Completado"
